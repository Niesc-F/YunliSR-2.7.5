...
pub fn onStartCocoonStage(session: *Session, packet: *const Packet, allocator: Allocator) !void {
    ...
    for (config.avatar_config.items, 0..) |avatarConf, idx| {
        ...
        if (avatar.id == 8007 or avatar.id == 8008 or avatar.id == 1402) {
            for (skills) |elem| {
		...
		if (avatarConf.use_technique) {
			...
			const buffs_unlocked = &[_]u32{
                100101, 100201, 100301, 100401, 100501, 100601, 100801, 100901, 101301, 110101, 110201, 110202, 110203, 110301, 110401, 110501, 110601, 110701, 110801,
                110901, 111001, 111101, 111201, 120101, 120301, 120401, 120501, 120601, 120701, 120702, 120801, 120802, 120901, 121001, 121101, 121201, 121202, 121203,
                121301, 121302, 121303, 121401, 121501, 121701, 121801, 122001, 122002, 122003, 122004, 122101, 122201, 122301, 122302, 122303, 122304, 122402,
                122403, 122501, 130101, 130201, 130301, 130302, 130303, 130401, 130402, 130403, 130404, 130405, 130406, 130501, 130601, 130602, 130701, 130801, 130802,
                130803, 130901, 130902, 130903, 131001, 131002, 131201, 131301, 131401, 131501, 131502, 131503, 131701, 131702, 140101, 140102, 140201, 140202,
				800301, 800501, 800701};
			
			var buffedAvatarId = avatar.id;
			if (avatar.id == 8003) {
				buffedAvatarId = 8004;
			} else if (avatar.id == 8005) {
				buffedAvatarId = 8006;
